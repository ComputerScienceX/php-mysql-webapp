...
if(!isset($_COOKIE['not_unique21'])) {
    setcookie('not_unique21', '1', time() + (86400 * 30)); //30 days
    ...
    $sql = "UPDATE likes2 SET count = count + 1 WHERE ID = 3";
...
//header("Location: https://computersciencex.com/pages/paid-content.php", true, 301);
