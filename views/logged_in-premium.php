...
<div class="col-xl-12">
    ...
    <div class="card border-0 py-6 px-4 mb-6 mb-xl-3 text-bg-primary">
        ...
        <h2 class="card-title"><?php echo $_SESSION['user_name']; ?></h2>
                        <p class="card-text"> your premium status:<?php if ($_SESSION['premium_status'] == 1){
                            echo "PREMIUM";
                        }else {
                            echo "FREE";
            ...
            <h2 class="card-title h4 text-uppercase opacity-80 text-center mb-3">Lifetime access</h2>
            ...
            <ul class="list-unstyled mb-7">
                <li class="mb-3">
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" height="12" width="12" class="me-2 text-white"><path d="M23.37.29a1.49,1.49,0,0,0-2.09.34L7.25,20.2,2.56,15.51A1.5,1.5,0,0,0,.44,17.63l5.93,5.94a1.53,1.53,0,0,0,2.28-.19l15.07-21A1.49,1.49,0,0,0,23.37.29Z" style="fill: currentColor"/></svg>
            ...
            <!-- Button -->
                ...
                <h3>a sample button bellow that will update the users premium status to TRUE when clicked</h3>

            <a class="btn btn-lg btn-white link-primary w-100" href="/premium-script.php">UPGRADE TO PREMIUM</a>
        </div>
    </div>
</div>
