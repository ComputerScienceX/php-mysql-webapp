...
$result = mysqli_query($con,"SELECT * FROM users3");
  ...
  height: auto;
                ...
                <div class="d-flex align-items-center ms-auto me-n1 me-lg-n2">
                    ...
                    <div class="dropdown">
                        ...
                        <div class="dropdown-menu">
                            ...
                            <a class="dropdown-item" href="admin.php?logout">Sign out</a>
                        </div>
                    </div>
                </div>
            </header>
    ...
    <thead>
        ...
        <tr>
            ...
            <th style="color:green;" scope="col">ID</th>

            <th style="color:green;" scope="col">USERNAME</th>

            <th style="color:green;" scope="col">EMAIL</th>

            <th style="color:green;" scope="col">PREMIUM STATUS</th>

            <th style="color:green;" scope="col">OPERATING SYSTEM</th>

<th style="color:green;" scope="col">BROWSER</th>

<th style="color:green;" scope="col">DEVICE</th>

<th style="color:green;" scope="col">LATEST IP USED AT LOGIN</th>
    ...
    <?php foreach(array_reverse($data) as $row): ?>
        ...
        <tr>
            ...
            <td>
            <?php if (htmlspecialchars($row['prem']) == 1){
                            echo '<small class="d-inline-flex mb-3 px-2 py-1 fw-semibold text-danger-emphasis bg-danger-subtle border border-danger-subtle rounded-2">PREMIUM</small>';
                        }else {
                                echo '<small class="d-inline-flex mb-3 px-2 py-1 fw-semibold text-success-emphasis bg-success-subtle border border-success-subtle rounded-2">FREE</small>' ;
                            } 
                            ?></td>

<td scope="row"><?= htmlspecialchars($row['os']) ?></td>
<td scope="row"><?= htmlspecialchars($row['browser']) ?></td>
<td scope="row"><?= htmlspecialchars($row['device']) ?></td>
<td scope="row"><?php /*Get user ip address*/
$ip_address=htmlspecialchars($row['ip']);
