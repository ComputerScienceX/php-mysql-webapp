                                                    ...
                                                    <div class="col-12">
                                                        ...
                                                        <div class="mb-4">
                                                            ...
                                                            <div class="input-group input-group-merge">
                                                                <input type="password" class="form-control" autocomplete="off" data-toggle-password-input placeholder="Your password" id="login_input_password"  name="admin-pass" required >
